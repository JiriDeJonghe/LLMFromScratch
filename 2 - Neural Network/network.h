...
*/
Layer* create_layer(size_t num_neurons, size_t num_inputs_per_neuron, ActivationFunc activation, ActivationFunc activation_derivative);
...
* @return Layer* Pointer to the created Layer, NULL if allocation fails
*/
NeuralNetwork* create_neural_network(size_t *layer_sizes, size_t num_layers, ActivationFunc *activations, ActivationFunc* activation_derivative);
